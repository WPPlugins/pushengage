...
//echo "<pre>";print_r($userdata);print_r($timezone);exit;
...
<?php }
else if($_SESSION['check_auth']['block_user'])
		{
      ...
      <div id="gSettings" class="<?php 
        ...
        <div class="col-md-8 col-lg-8">
          <div class="panel panel-default">
            ...
            <div class="form-field term-parent-wrap">
              <label for="parent"><strong>Use Require Interaction</strong></label>
              <input type="checkbox" name="pushengage-require-interaction" value="1" <?php checked( $pushengage_settings['use_require_interaction'], 1 ); ?> />
              Use require interaction for notifications.
            </div>
            <div class="checkbox">
                  <label>
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form role="form" id="create_segment_form" method="post" enctype="multipart/form-data">
              ...
              <div>
              <button type="submit" class="btn btn-primary">Update Optin Settings</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="col-md-6 col-lg-6">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-md-6" id="right_workspace" style="margin-top:10px">
            </div>
...
.arrow_box:before {
  ...
  margin-left: -165px;
      ...
      <div class="col-md-6 col-lg-6 browser-mockup" style="background-color: #fff;text-align: center;padding: 35px;">
          <img src="<?php echo $result->site_image;?>" style="max-width: 80px;">
        ...
        if(setSiteType=="https")
        {
          $('#http-single-step-popup,.pushengagesweet-alert-optin-4').slideUp();
           ...
           // $("._statusDDL").val(2).change();
            ...
            update_optin_ui();
            $('#intermediate-page-hide').slideUp();
...
function update_optin_ui_text()
       ...
       switch($("[name=optin_type]").val()){
           ...
           $("#right_workspace").html("<div id='pushengage_confirm'><div id='http-single-step-popup' class='alert-browser-notification-popup arrow_box'><span class='notification-content-close'>&#10006;</span><p class='alert-browser-notification-popup-url'><?php echo $site_subdomain_for_browser_popup."."?>pushengage.com want to:</p><p class='alert-browser-notification-popup-show'><img src='<?php echo PUSHENGAGE_PLUGIN_URL.'images/bell.png'?>'; style='width:18px;margin: 0 8px 0 23px;height: 15px;'></img>Show notifications</p><p style='text-align:right'><a class='notification-allow'>Allow</a><a class='notification-close'>Block</a></p></div><div class='pushengagesweet-alert-optin-4 showpushengagesweetAlert visible'><div class='pushengagesweet-alert-optin-4-content'><h2 id='_pe_optin_settings_optin_title'>"+_pe_optin_settings.desktop.optin_title+"</h2><p class='pushengagesweet-alert-optin-4-poweredby'>powered by PushEngage.com</p></div><div class='sa-button-container'><div class='sa-confirm-button-container'><button class='confirm' >CLOSE</button></div></div></div><div class='alert-browser-notification-popup arrow_box' id='https-single-step-popup'><span class='notification-content-close'>&#10006;</span><p class='alert-browser-notification-popup-url'><?php echo $site_url_for_browser_popup;?> want to:</p><p class='alert-browser-notification-popup-show'><img src='<?php echo PUSHENGAGE_PLUGIN_URL.'images/bell.png'?>';'  style='width:18px;margin: 0 8px 0 23px;height: 15px;''></img>Show notifications</p><p style='text-align:right'><a class='notification-allow'>Allow</a><a class='notification-close'>Block</a></p></div></div>");
            
            if (httpsPopupSet==0)
            {
              $('#http-single-step-popup,.pushengagesweet-alert-optin-4').show();
            ...
            if (httpsPopupSet==1)
            {
              ...
              $('#http-single-step-popup,.pushengagesweet-alert-optin-4').hide();
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form role="form" id="create_segment_form" method="post" enctype="multipart/form-data">
								...
								<?php if($verify_gcm_result['banner']){?>
								<div class="kode-alert kode-alert-icon alert1-light">
									<i class="fa fa-info"></i>
									<?php echo $verify_gcm_result['banner'];?>
								</div>
								<?php } ?>
								<div class="form-group">
									<label for="site_name">GCM Project Key</label>
									<input type="text" class="form-control" id="site_name" required maxlength="250" name="gcm_project_key" placeholder="Enter GCM Project Key here" value="<?php echo ($gcmdata->gcm_project_key)?$gcmdata->gcm_project_key:"";?>">
