<?php
	...
	class Pushengage
	{
		...
		public static $pushengage_version = '1.4.3';
		public static $database_version = 20170427;
					...
					if(isset($_POST['plan-switch']) && $_POST['plan-switch'] == "on")
					{
						$optindata = array(
							'desktop'=> array(
								...
								'https' =>array( 'optin_delay' => $_POST['optin_delay'],'optin_type' => $_POST['optin_type'],'optin_title' => $_POST['optin_title'],'optin_allow_btn_txt' => $_POST['optin_allow_btn_txt'],'optin_close_btn_txt' => $_POST['optin_close_btn_txt'],'optin_font' =>''
					 		)
						...
						$optindata = array(
							'desktop'=> array(
								'http' =>array( 'optin_delay' => $_POST['optin_delay'],'optin_type' => $_POST['optin_type'],'optin_title' => $_POST['optin_title'],'optin_allow_btn_txt' => $_POST['optin_allow_btn_txt'],'optin_close_btn_txt' => $_POST['optin_close_btn_txt'],'optin_font' =>''
					 		),
		...
		public static function pushengageDomainScripts()
		{
			...
			$pe_dynemic_js = '//clientcdn.pushengage.com/core/'.$appdata['site_id'].'.js';
			
			if($app_key && isset($appdata['site_id']))
			{
